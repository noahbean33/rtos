...
void task0(void) // main thread run for an infinite number of times, where as a periodic thread runs once and returns
{
	for(;;)
	{
		Task0_Profiler++;
...
void task1(void) // main thread run for an infinite number of times, where as a periodic thread runs once and returns
{
	for(;;)
	{
		Task1_Profiler++;
...
void task2(void) // main thread run for an infinite number of times, where as a periodic thread runs once and returns
{
	for(;;)
	{
		Task2_Profiler++;
