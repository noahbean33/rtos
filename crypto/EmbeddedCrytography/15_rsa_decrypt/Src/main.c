...
int main()
{
	...
	/* Verify API returned value */
	   ...
	   retval = cmox_rsa_pkcs1v22_decrypt(&rsa_ctx,                                           /* RSA context */
	                                      ...
	                                      expected_encrypted_text, sizeof(expected_encrypted_text),   /* Encrypted message */
	   ...
	   if (retval != CMOX_RSA_SUCCESS)
	   {
			 handle_error("RSA decryption failed!");
	   ...
	   {
			 handle_error("RSA decryption content mismatch!");
