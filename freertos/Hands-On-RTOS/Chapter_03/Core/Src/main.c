 ...
 * - This is a super-loop program generated by STMCubeIDE. There is no OS.
 * - Code was added to toggle an LED
 * - For each loop iteration:
 *   - Toggles the green LED, with 1 second delay
 *   - Sends diagnostic messages to the SystemView app
 *
 * USE:
...
/**
   Licenses:
   - Content that is generated by ST software is copyrighted 2022 by ST, under the BSD 3-Clause license.
   - Added content is copyrighted (c) by PACKT, 2025, under the MIT License.
